...
async def main():
    ...
    print(f"  GOOGLE_SEARCH_API_KEY: {'✓' if os.getenv('GOOGLE_SEARCH_API_KEY') else '✗'}")
    print(f"  GOOGLE_SEARCH_ENGINE_ID: {'✓' if os.getenv('GOOGLE_SEARCH_ENGINE_ID') else '✗'}")
    print(f"  BRAVE_SEARCH_API_KEY: {'✓' if os.getenv('BRAVE_SEARCH_API_KEY') else '✗'}")
    print(f"  AZURE_OPENAI_ENDPOINT: {'✓' if os.getenv('AZURE_OPENAI_ENDPOINT') else '✗'}")
    print(f"  AZURE_OPENAI_API_KEY: {'✓' if os.getenv('AZURE_OPENAI_API_KEY') else '✗'}")
