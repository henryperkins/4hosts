...
from database.models import (
    User, ResearchQuery, APIKey, UserSession,
    user_saved_searches, UserRole, ResearchStatus, ParadigmType
)
...
class UserProfileService:
    ...
    async def get_user_profile(self, user_id: UUID) -> Optional[Dict[str, Any]]:
        ...
        async with get_db_context() as session:
            ...
            completed_research = sum(
                1 for r in user.research_queries 
    ...
    async def update_user_profile(
        ...
        """Update user profile"""
        allowed_fields = {
            "full_name", "avatar_url", "bio", "preferences"
        }
...
class SavedSearchesService:
    ...
    async def get_saved_searches(
        ...
        async with get_db_context() as session:
            ...
            if tags:
                ...
                for tag in tags:
                    tag_conditions.append(
                        user_saved_searches.c.tags.contains([tag])
                    )
            ...
            # Order by saved date
            stmt = stmt.order_by(
                user_saved_searches.c.saved_at.desc()
...
class APIKeyService:
    ...
    async def update_api_key(
        ...
        allowed_fields = {
            "name", "allowed_origins", "allowed_ips", "rate_limit_tier"
        }
...
class ResearchHistoryService:
    ...
    async def get_research_statistics(
        ...
        async with get_db_context() as session:
            ...
            stmt = (
                select(
                    ...
                    func.count(
                        ...
                        ResearchQuery.status == ResearchStatus.COMPLETED
            ...
            paradigm_dist = {
                row.primary_paradigm: row.count
                for row in paradigm_result
            }
