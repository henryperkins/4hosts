...
async def test_orchestrator():
    ...
    for i, (query, (paradigm, description)) in enumerate(zip(test_queries, paradigm_mappings)):
...
async def test_multi_paradigm():
    ...
    try:
        ...
        print(f"  ✓ Primary paradigm sections: {len(combined['primary_paradigm']['answer'].sections)}")
        if combined['secondary_paradigm']:
            print(f"  ✓ Secondary paradigm sections: {len(combined['secondary_paradigm']['answer'].sections)}")
