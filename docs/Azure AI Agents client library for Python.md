...
source: "https://learn.microsoft.com/en-us/python/api/overview/azure/ai-agents-readme?view=azure-python-preview&preserve-view=true"
author:
  - "[[azure-sdk]]"
published:
created: 2025-09-22
...
- [Getting started](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#getting-started)
	- [Prerequisite](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#prerequisite)
	- [Install the package](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#install-the-package)
- [Key concepts](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#key-concepts)
	- [Create and authenticate the client](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#create-and-authenticate-the-client)
- [Examples](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#examples)
	- [Create an Agent](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#create-agent) with:
		- [File Search](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#create-agent-with-file-search)
		- [Enterprise File Search](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#create-agent-with-enterprise-file-search)
		- [Code interpreter](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#create-agent-with-code-interpreter)
		- [Bing grounding](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#create-agent-with-bing-grounding)
		- [Azure AI Search](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#create-agent-with-azure-ai-search)
		- [Function call](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#create-agent-with-function-call)
		- [Azure Function Call](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#create-agent-with-azure-function-call)
		- [OpenAPI](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#create-agent-with-openapi)
		- [Browser Automation](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#create-agent-with-browser-automation)
		- [Fabric data](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#create-an-agent-with-fabric)
		- [Connected agents](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#create-an-agent-using-another-agents)
		- [Deep Research](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#create-agent-with-deep-research)
		- [MCP](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#create-agent-with-mcp)
	- [Create thread](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#create-thread) with
		- [Tool resource](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#create-thread-with-tool-resource)
	- [Create message](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#create-message) with:
		- [File search attachment](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#create-message-with-file-search-attachment)
		- [Code interpreter attachment](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#create-message-with-code-interpreter-attachment)
		- [Create Message with Image Inputs](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#create-message-with-image-inputs)
	- [Execute Run, Run\_and\_Process, or Stream](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#execute-run-run_and_process-or-stream)
	- [Retrieve message](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#retrieve-message)
	- [Retrieve file](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#retrieve-file)
	- [Tear down by deleting resource](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#teardown)
	- [Tracing](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#tracing)
		- [Installation](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#installation)
		- [How to enable tracing](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#how-to-enable-tracing)
		- [Enabling content recording](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#enabling-content-recording)
		- [How to trace your own functions](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#how-to-trace-your-own-functions)
		- [Adding custom attributes to spans](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#adding-custom-attributes-to-spans)
- [Troubleshooting](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#troubleshooting)
	- [Logging](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#logging)
	- [Reporting issues](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#reporting-issues)
- [Next steps](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#next-steps)
- [Contributing](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#contributing)
...
- A [project in Azure AI Foundry](https://learn.microsoft.com/en-us/azure/ai-studio/how-to/create-projects).
...
- Entra ID is needed to authenticate the client. Your application needs an object that implements the [TokenCredential](https://learn.microsoft.com/en-us/python/api/azure-core/azure.core.credentials.tokencredential) interface. Code samples here use [DefaultAzureCredential](https://learn.microsoft.com/en-us/python/api/azure-identity/azure.identity.defaultazurecredential). To get that working, you will need:
	- An appropriate role assignment. see [Role-based access control in Azure AI Foundry portal](https://learn.microsoft.com/en-us/azure/ai-foundry/concepts/rbac-ai-foundry). Role assigned can be done via the "Access Control (IAM)" tab of your Azure AI Project resource in the Azure portal.
...
To use this SDK, start by creating an `AIProjectClient`. For more information on `azure-ai-projects`, refer to its [README](https://github.com/Azure/azure-sdk-for-python/blob/azure-ai-agents_1.2.0b4/sdk/ai/azure-ai-projects/README.md).
...
To enable your Agent to do detailed research of a topic, use the `DeepResearchTool` along with a connection to a Bing Grounding resource. This scenarios requires you to specify two model deployments. One is the generic chat model that does arbitration, and is specified as usual when you call the `create_agent` method. The other is the Deep Research model, which is specified when you define the `DeepResearchTool`.
...
> **Limitation**: The Deep Research tool is currently recommended **only** in non-streaming scenarios. Using it with streaming can work, but it may occasionally time-out and is therefore not yet recommended.

To enable your Agent to connect to a MCP server, use the `McpTool` along with a server URI to a MCP server and a label for that server. Note that approval to send data to that server is required by default (but can be set to not required for each run).
...
For more details about requirements and specification of functions, refer to [Function Tool Specifications](https://github.com/Azure/azure-sdk-for-python/blob/azure-ai-agents_1.2.0b4/sdk/ai/azure-ai-agents/FunctionTool.md)

Here is an example to use [user functions](https://github.com/Azure/azure-sdk-for-python/blob/azure-ai-agents_1.2.0b4/sdk/ai/azure-ai-agents/samples/utils/user_functions.py) in `toolset`:
...
- For examples of automatic function calls in action, refer to [`sample_agents_auto_function_call.py`](https://github.com/Azure/azure-sdk-for-python/blob/azure-ai-agents_1.2.0b4/sdk/ai/azure-ai-agents/samples/agents_tools/sample_agents_auto_function_call.py) or [`sample_agents_auto_function_call_async.py`](https://github.com/Azure/azure-sdk-for-python/blob/azure-ai-agents_1.2.0b4/sdk/ai/azure-ai-agents/samples/agents_async/sample_agents_auto_function_call_async.py).
- If you prefer to manage function execution manually, refer to [`sample_agents_stream_eventhandler_with_functions.py`](https://github.com/Azure/azure-sdk-for-python/blob/azure-ai-agents_1.2.0b4/sdk/ai/azure-ai-agents/samples/agents_streaming/sample_agents_stream_eventhandler_with_functions.py) or [`sample_agents_functions.py`](https://github.com/Azure/azure-sdk-for-python/blob/azure-ai-agents_1.2.0b4/sdk/ai/azure-ai-agents/samples/agents_tools/sample_agents_functions.py).
...
[Azure Functions Python Developer Guide](https://learn.microsoft.com/en-us/azure/azure-functions/create-first-function-cli-python?tabs=windows,bash,azure-cli,browser) **Note:** The Azure Function may be only used in standard agent setup. Please follow the [instruction](https://github.com/azure-ai-foundry/foundry-samples/tree/main/samples/microsoft/infrastructure-setup/41-standard-agent-setup) to deploy an agent, capable of calling Azure Functions.
...
Logic Apps allow HTTP requests to trigger actions. For more information, refer to the guide [Logic App Workflows for Function Calling](https://learn.microsoft.com/en-us/azure/ai-services/openai/how-to/assistants-logic-apps).
...
To enable your Agent to perform automated Browser navigation tasks, you will need the `BrowserAutomationTool`, along with a connection to a [Microsoft Playwright Workspace](https://azure.microsoft.com/products/playwright-testing) resource.
...
We can use `ConnectedAgentTool` to call specialized agents. In the example below we will create two agents, one is returning the Microsoft stock price and another returns weather. Note that the `ConnectedAgentTool` does not support local functions, we will use Azure function to return weather. The code of that function is given below; please see [Azure Function Call](https://learn.microsoft.com/en-us/python/api/overview/azure/?view=azure-python-preview&preserve-view=true#create-agent-with-azure-function-call) section for the instructions on how to deploy Azure Function.
...
To list all threads attached to a given agent, use the list\_threads API:
...
`runs.create` requests the Agent to process the message without polling for the result. If you are using `function tools`, your code is responsible for polling for the result and acknowledging the status of `Run`. When the status is `requires_action`, your code is responsible for calling the function tools. For a code sample, visit [`sample_agents_functions.py`](https://github.com/Azure/azure-sdk-for-python/blob/azure-ai-agents_1.2.0b4/sdk/ai/azure-ai-agents/samples/agents_tools/sample_agents_functions.py).
...
With streaming, polling need not be considered. If `function tools` were added to the agents, you should decide to have the function tools called manually or automatically. Please visit [`manual function call sample`](https://github.com/Azure/azure-sdk-for-python/blob/azure-ai-agents_1.2.0b4/sdk/ai/azure-ai-agents/samples/agents_streaming/sample_agents_stream_eventhandler_with_functions.py) or [`automatic function call sample`](https://github.com/Azure/azure-sdk-for-python/blob/azure-ai-agents_1.2.0b4/sdk/ai/azure-ai-agents/samples/agents_streaming/sample_agents_stream_iteration_with_toolset.py).
...
As you can see, this SDK parses the events and produces various event types similar to OpenAI agents. In your use case, you might not be interested in handling all these types and may decide to parse the events on your own. To achieve this, please refer to [override base event handler](https://github.com/Azure/azure-sdk-for-python/blob/azure-ai-agents_1.2.0b4/sdk/ai/azure-ai-agents/samples/agents_streaming/sample_agents_stream_with_base_override_eventhandler.py).
...
You will also need an exporter to send telemetry to your observability backend. You can print traces to the console or use a local viewer such as [Aspire Dashboard](https://learn.microsoft.com/en-us/dotnet/aspire/fundamentals/dashboard/standalone?tabs=bash).
...
To enable content recording set the `OTEL_INSTRUMENTATION_GENAI_CAPTURE_MESSAGE_CONTENT` environment variable to `true`. This environment variable is defined by [OpenTelemetry](https://opentelemetry.io/), and all new applications are encouraged to use it when content recording is required. For legacy reasons, content recordings will also be enabled if `AZURE_TRACING_GEN_AI_CONTENT_RECORDING_ENABLED` environment variable is set to `true`.
...
Have a look at the [Samples](https://github.com/Azure/azure-sdk-for-python/tree/azure-ai-agents_1.2.0b4/sdk/ai/azure-ai-agents/samples) folder, containing fully runnable Python code for synchronous and asynchronous clients.
