...
<svg viewBox="0 0 1400 1600" xmlns="http://www.w3.org/2000/svg">
  ...
  <g transform="translate(50, 470)">
    ...
    <!-- Select Layer -->
    <rect x="370" y="50" width="280" height="200" fill="#dbeafe" stroke="#2563eb" stroke-width="2" rx="5"/>
    ...
    <text x="510" y="195" text-anchor="middle" font-size="11" font-style="italic">+ DOLORES: "Amazon antitrust"</text>
    
    <!-- Compress Layer -->
    <rect x="690" y="50" width="280" height="200" fill="#dbeafe" stroke="#2563eb" stroke-width="2" rx="5"/>
    <text x="830" y="75" text-anchor="middle" font-size="14" font-weight="bold">🗜️ Compress Layer</text>
    <text x="830" y="95" text-anchor="middle" font-size="11" font-weight="bold">MAEVE: 40% compression</text>
    <text x="830" y="115" text-anchor="middle" font-size="10">Focus on:</text>
    <text x="830" y="130" text-anchor="middle" font-size="10">• Actionable strategies</text>
    <text x="830" y="145" text-anchor="middle" font-size="10">• Implementation steps</text>
    <text x="830" y="160" text-anchor="middle" font-size="10">• Success metrics</text>
    <text x="830" y="175" text-anchor="middle" font-size="10">• Quick wins</text>
    <text x="830" y="195" text-anchor="middle" font-size="11" font-style="italic">Remove: Theory, history</text>
    
    <!-- Isolate Layer -->
    <rect x="1010" y="50" width="280" height="200" fill="#dbeafe" stroke="#2563eb" stroke-width="2" rx="5"/>
    <text x="1150" y="75" text-anchor="middle" font-size="14" font-weight="bold">🚪 Isolate Layer</text>
    <text x="1150" y="95" text-anchor="middle" font-size="11" font-weight="bold">Extract Key Intel:</text>
    <text x="1150" y="115" text-anchor="middle" font-size="10">1. Local advantage strategies</text>
    <text x="1150" y="130" text-anchor="middle" font-size="10">2. Niche domination tactics</text>
    <text x="1150" y="145" text-anchor="middle" font-size="10">3. Community integration</text>
    <text x="1150" y="160" text-anchor="middle" font-size="10">4. Tech leverage points</text>
    <text x="1150" y="175" text-anchor="middle" font-size="10">5. Partnership opportunities</text>
    <text x="1150" y="195" text-anchor="middle" font-size="11" font-style="italic">+ Policy changes coming</text>
  </g>

  <!-- Research Execution -->
  <g transform="translate(50, 780)">
    <rect x="0" y="0" width="1300" height="250" fill="#dcfce7" stroke="#10b981" stroke-width="2" rx="10"/>
    <text x="650" y="30" text-anchor="middle" font-size="18" font-weight="bold">4. Research Execution Layer</text>
    
    <!-- Web Search -->
    <rect x="50" y="50" width="400" height="180" fill="#d1fae5" stroke="#059669" stroke-width="2" rx="5"/>
    <text x="250" y="75" text-anchor="middle" font-size="14" font-weight="bold">🌐 Paradigm-Aware Search</text>
    <text x="250" y="95" text-anchor="middle" font-size="11">Searches executed (MAEVE priority):</text>
    <text x="250" y="110" text-anchor="middle" font-size="10">1. "small business beat Amazon 2024" → 847 results</text>
    <text x="250" y="125" text-anchor="middle" font-size="10">2. "local retailer advantages Amazon" → 523 results</text>
    <text x="250" y="140" text-anchor="middle" font-size="10">3. "niche market strategy examples" → 1,204 results</text>
    <text x="250" y="155" text-anchor="middle" font-size="10">4. "Amazon weakness exploit business" → 392 results</text>
    <text x="250" y="170" text-anchor="middle" font-size="10">5. [DOLORES] "Amazon monopoly local" → 621 results</text>
    <text x="250" y="185" text-anchor="middle" font-size="10">6. [Industry] "Retail strategy reports" → 178 results</text>
    <text x="250" y="205" text-anchor="middle" font-size="11" font-weight="bold">Total sources analyzed: 3,765</text>
    
    <!-- Source Analysis -->
    <rect x="500" y="50" width="350" height="180" fill="#d1fae5" stroke="#059669" stroke-width="2" rx="5"/>
    <text x="675" y="75" text-anchor="middle" font-size="14" font-weight="bold">📊 Source Credibility</text>
    <text x="675" y="95" text-anchor="middle" font-size="11">MAEVE source weights applied:</text>
    <text x="675" y="115" text-anchor="middle" font-size="10">✓ HBR strategy article: 0.95</text>
    <text x="675" y="130" text-anchor="middle" font-size="10">✓ McKinsey report: 0.92</text>
    <text x="675" y="145" text-anchor="middle" font-size="10">✓ Successful case study: 0.88</text>
    <text x="675" y="160" text-anchor="middle" font-size="10">✓ Reddit discussion: 0.45</text>
    <text x="675" y="175" text-anchor="middle" font-size="10">✗ Opinion blog: 0.25</text>
    <text x="675" y="195" text-anchor="middle" font-size="11" font-weight="bold">High-quality sources: 47</text>
