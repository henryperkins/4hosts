...
from .search_apis import SearchResult, SearchConfig, SearchAPIManager, create_search_manager
...
class DoloresSearchStrategy:
    ...
    def __init__(self):
        ...
        self.query_modifiers = [
            "controversy", "scandal", "expose", "corrupt", "injustice",
            "systemic", "inequality", "power abuse", "cover-up", 
            "investigation", "whistleblower", "leak"
        ]
        ...
        self.preferred_sources = [
            ...
            "motherjones.com", "thenation.com", "theguardian.com",
            "washingtonpost.com", "nytimes.com", "icij.org"
        ]
        
        # Search operators for finding hidden information
        self.search_operators = [
            "\"leaked documents\"", "\"internal memo\"", "\"confidential\"",
            "\"investigation reveals\"", "\"according to sources\"",
            "\"documents show\"", "\"expose\"", "\"scandal\""
        ]
    
    async def generate_search_queries(self, context: SearchContext) -> List[Dict[str, Any]]:
    ...
    async def filter_and_rank_results(self, results: List[SearchResult], 
    ...
    async def _calculate_dolores_score(self, result: SearchResult, context: SearchContext) -> float:
        ...
        investigative_keywords = ["expose", "reveal", "investigation", "scandal", 
                                "corruption", "injustice", "systemic", "power"]
        
        text = (result.title + " " + result.snippet).lower()
        keyword_matches = sum(1 for keyword in investigative_keywords if keyword in text)
...
class TeddySearchStrategy:
    ...
    def __init__(self):
        ...
        self.query_modifiers = [
            "support", "help", "resources", "community", "assistance",
            "care", "protection", "safety", "wellbeing", "services",
            "nonprofit", "charity", "aid", "relief"
        ]
        
        self.preferred_sources = [
            "npr.org", "pbs.org", "unitedway.org", "redcross.org",
            "who.int", "unicef.org", "doctorswithoutborders.org",
            "goodwill.org", "salvationarmy.org", "feedingamerica.org",
            "habitat.org", "americanredcross.org"
        ]
        
        self.search_operators = [
            "\"support services\"", "\"community resources\"", "\"help available\"",
            "\"assistance programs\"", "\"care options\"", "\"nonprofit\"",
    ...
    async def _calculate_teddy_score(self, result: SearchResult, context: SearchContext) -> float:
        ...
        care_keywords = ["help", "support", "care", "assist", "community", "service",
                        "nonprofit", "charity", "volunteer", "aid", "relief"]
...
class BernardSearchStrategy:
    ...
    def __init__(self):
        ...
        self.query_modifiers = [
            ...
            "evidence", "findings", "peer reviewed", "academic",
            "methodology", "empirical", "systematic review"
        ]
        
        self.preferred_sources = [
            "nature.com", "science.org", "arxiv.org", "pubmed.ncbi.nlm.nih.gov",
            "scholar.google.com", "jstor.org", "researchgate.net",
            "springerlink.com", "sciencedirect.com", "wiley.com",
            "tandfonline.com", "cambridge.org"
        ]
        
        self.search_operators = [
            "\"peer reviewed\"", "\"systematic review\"", "\"meta-analysis\"",
            "\"research study\"", "\"empirical evidence\"", "\"data analysis\"",
    ...
    async def _calculate_bernard_score(self, result: SearchResult, context: SearchContext) -> float:
        ...
        research_keywords = ["study", "research", "analysis", "data", "peer reviewed",
                           "methodology", "findings", "evidence", "statistical"]
...
class MaeveSearchStrategy:
    ...
    def __init__(self):
        ...
        self.query_modifiers = [
            "strategy", "competitive", "market", "business", "industry",
            "analysis", "trends", "insights", "opportunities", "framework",
            "implementation", "optimization", "roi", "performance"
        ]
        
        self.preferred_sources = [
            "wsj.com", "ft.com", "bloomberg.com", "forbes.com",
            "hbr.org", "mckinsey.com", "bcg.com", "strategy-business.com",
            "bain.com", "deloitte.com", "pwc.com", "kpmg.com",
            "gartner.com", "forrester.com"
        ]
        
        self.search_operators = [
            "\"business strategy\"", "\"competitive analysis\"", "\"market trends\"",
            "\"industry insights\"", "\"best practices\"", "\"case study\"",
    ...
    async def _calculate_maeve_score(self, result: SearchResult, context: SearchContext) -> float:
        ...
        if result.domain in self.preferred_sources:
            score += 0.3
        elif any(term in result.domain for term in ['business', 'market', 'industry', 'consulting']):
            score += 0.2
        
        # Bonus for strategic keywords
        strategy_keywords = ["strategy", "competitive", "market", "business", "industry",
                           "framework", "implementation", "optimize", "roi", "performance"]
        ...
        action_keywords = ["how to", "implement", "step", "guide", "framework", "process"]
