...
- [Python (API Key)](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/?tabs=python-key#tabpanel_1_python-key)
- [Python (Microsoft Entra ID)](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/?tabs=python-key#tabpanel_1_python-secure)
- [REST API](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/?tabs=python-key#tabpanel_1_rest-api)
- [Output](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/?tabs=python-key#tabpanel_1_output)
...
### Four Hosts default model mapping (Azure)

- Deployments available: `o3`, `gpt-4.1`, `gpt-4.1-mini` (deployment names match model names).
- The backend now passes the requested model directly to Azure’s Responses API, so you can choose per-call:

```python
# Example: pick a specific deployment per call
client.responses.create(
  model="gpt-4.1-mini",  # or "o3" or "gpt-4.1"
...
- `AZURE_OPENAI_API_VERSION` defaults to `preview` if not set.
- `DEEP_RESEARCH_MODEL` (optional) controls the model used by the deep‑research service.
  - If unset, Azure defaults to `o3`; non‑Azure defaults to `o3-deep-research`.

To retrieve a response from a previous call to the responses API.

- [Python (API Key)](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/?tabs=python-key#tabpanel_2_python-key)
- [Python (Microsoft Entra ID)](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/?tabs=python-key#tabpanel_2_python-secure)
- [REST API](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/?tabs=python-key#tabpanel_2_rest-api)
- [Output](https://learn.microsoft.com/en-us/azure/ai-foundry/openai/how-to/?tabs=python-key#tabpanel_2_output)
