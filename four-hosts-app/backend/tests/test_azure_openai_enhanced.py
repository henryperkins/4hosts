...
async def test_conversation():
    ...
    messages = [
        ...
        {"role": "assistant", "content": "Consciousness is the state of being aware of and able to think about one's existence, sensations, thoughts, and surroundings."},
...
async def main():
    ...
    if not azure_endpoint or not azure_api_key:
        print("❌ Azure OpenAI not configured. Please set AZURE_OPENAI_ENDPOINT and AZURE_OPENAI_API_KEY")
        return
