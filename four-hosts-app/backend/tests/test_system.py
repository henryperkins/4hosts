...
from services.research_orchestrator import initialize_research_system, research_orchestrator
...
async def test_cache_system():
    ...
    try:
        ...
        if success:
            ...
            print("   ⚠ Cache initialization failed (Redis not available - this is expected)")
...
async def test_credibility_system():
    ...
    try:
        ...
        for domain, paradigm in test_domains:
            ...
            print(f"     Bias: {credibility.bias_rating}, Authority: {credibility.domain_authority}")
...
async def test_research_orchestrator():
    ...
    try:
        ...
        print(f"   ✓ System stats retrieved: {stats.get('total_executions', 0)} executions")
